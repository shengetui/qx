...
(function(module) {
    (function() {
        ...
        NODE_JS ? root = pt : WEB_WORKER && (root = self);
...
w = e => {
    var t = new URLSearchParams(e),
        n = {};
    for (var a of t.keys()) n[a] = t.get(a);
    return n
},  t = 1706754015106;
let body = `pwd=123&cc=11`;
...
console.log(p)
    Tt =   (e, t) => {
        ...
        const p = V(n);
        console.log(p+"------")
        console.log( S(`${S(p)}${t}`).toUpperCase())

        console.log( t)
        console.log( p)
        console.log( S(p))
        console.log( `${S(p)}${t}`)
        //E4E1D14DC64138B3A47C26C58F094BA7
...
let f = e => {
    !e || Object.keys(e)
        .forEach(t => {
            (e[t] === void 0 || e[t] === null || e[t] === "") && e[t] !== 0 && delete e[t]
        })
}
    ...
    let o =  Tt(p, t),
        c = {
            ...
            "X-Ca-Timestamp": o.time,
            "X-Ca-Signature": o.data,
        };
