...
// Get current timestamp in milliseconds
    ...
    let token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHBpcmVUaW1lIjoxNzA3OTc2ODg3ODk0LCJpc3MiOiJzdGFyQ2hhcmdlQXBwIiwiYXBwa2V5IjoiYjlFNTJCQTBpVjlpNDJkMTdjIiwiZXhwIjoxNzA3OTc2ODg3LCJpYXQiOjE3MDY3NjcyODcsInVzZXJJZCI6IjA2NjAzMDUzLTgwMzUtNDllZC1hNGY3LTNhMzM0ZjUzOTY3ZiJ9.tn9C0tqwuiJloHFXs5ZU9oIwzucGtWs6g3EDm_lxNFQ';
    console.log(m2);
    let url = "https://gateway.starcharge.com/apph5/xcxApiV2/wechat/starPoint/sign";
    ...
    let opt = {
        ...
        method :"POST",
        headers : {
            'X-Ca-Timestamp': timestampInMilliseconds.toString(),
            ...
            'channel-id': '100',
            'Sec-Fetch-Mode': 'cors',
            'userId': '06603053-8035-49ed-a4f7-3a334f53967f'
        },
        body: ``
    }
